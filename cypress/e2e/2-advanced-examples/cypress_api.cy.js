...
context('Cypress APIs', () => {
  ...
  context('Cypress.Commands', () => {
    ...
    it('.add() - create a custom command', () => {
      Cypress.Commands.add('console', { prevSubject: true }, (subject, method = 'log') => {
        // log the subject to the console using the specified method
        console[method]('The subject is', subject);
        // return the subject to allow for chaining
        return subject;
      });
  ...
  context('Cypress.Cookies', () => {
    ...
    it('.debug() - enable or disable debugging', () => {
      ...
      // Cypress will now log in the console when cookies are set or cleared
  ...
  context('Cypress.log', () => {
    ...
    it('Control what is printed to the Command Log', () => {
      // This test can be expanded with specific logging control tests
